...
final digifitCacheDataServiceProvider = Provider((ref) =>
    DigifitCacheDataService(
        ref: ref,
        sharedPreferenceHelper: ref.read(sharedPreferenceHelperProvider)));

class DigifitCacheDataService {
  Ref ref;
  ...
  Future<Either<Exception, BaseModel>> call(
    ...
    final path = '$digifitCacheDataEndPoint?translate=${params["translate"]}';
